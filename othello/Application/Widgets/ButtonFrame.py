...
class ButtonFrame(Frame):
    ...
    def __init__(self, master, colour_scheme, **kw):
        ...
        # Button Frame
        self.game_button = Button(self, text="Game Modes", font=("Times New Roman", 16), foreground=self.colour.TEXT_COLOUR,
                                  width=18, padx=0, bg=self.colour.BUTTON_COLOUR)
        ...
        self.settings = Button(self, text="Settings", font=("Times New Roman", 16), foreground=self.colour.TEXT_COLOUR,
                               width=18, padx=0, bg=self.colour.BUTTON_COLOUR)
        ...
        self.quit = Button(self, text="Exit", font=("Times New Roman", 16), foreground=self.colour.TEXT_COLOUR,
                           width=18, padx=0, bg=self.colour.BUTTON_COLOUR)
