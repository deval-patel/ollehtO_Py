...
=======
    TODO: Explain
>>>>>>> e19af33... Made a GUI for ollehtO, has main Application class which is used to run the GUI, has supporting widget classes, in the package Widget, also contains pictures for the GUI to use
    """
    frame: Frame
    header: Label
    images: ImageFrame
